...
public class PrimeGenerator {
	...
	*/
	...
	public static BigInteger[] randomBigIntsOfBitSize(int nbBits) {
		String minS = "1";
		String maxS = "1";
		for (int i = 1; i < nbBits; i++) {
			minS += "0";
	...
	public static BigInteger randomBigIntBetween(BigInteger start, BigInteger end){
	...
	public static boolean testPrime(BigInteger randomBig){
		return nbPremierSur(randomBig, 32);
	}
